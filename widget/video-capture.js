...
function openLive(ctx){
  ...
  var _svgP='<svg class="bugaputa-live-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">',_svgS='</svg>';var _ico={select:_svgP+'<path d="M5 3l14 9-7 1-3 7z"/><path d="M12 13l-3 7"/>'+_svgS,pen:_svgP+'<path d="M17 3a2.8 2.8 0 0 1 4 4L7 21l-4 1 1-4z"/><path d="M15 5l4 4"/>'+_svgS,arrow:_svgP+'<path d="M5 12h14"/><path d="M13 5l7 7-7 7"/>'+_svgS,rect:_svgP+'<rect x="3" y="3" width="18" height="18" rx="2"/>'+_svgS,text:_svgP+'<path d="M4 7h16"/><path d="M12 7v10"/><path d="M8 17h8"/>'+_svgS};
  ...
  var undo=h('button',{type:'button','aria-label':'Undo',title:'Undo',html:_svgP+'<path d="M9 8H5v5"/><path d="M5 8a8 8 0 1 0 2-2"/>'+_svgS}), redo=h('button',{type:'button','aria-label':'Redo',title:'Redo',html:_svgP+'<path d="M15 8h4v5"/><path d="M19 8a8 8 0 1 1-2-2"/>'+_svgS}), del=h('button',{type:'button','aria-label':'Delete selected',title:'Delete selected',html:_svgP+'<path d="M3 6h18"/><path d="M8 6V4h8v2"/><path d="M19 6l-1 14H6L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/>'+_svgS}), clr=h('button',{type:'button','aria-label':'Clear all',title:'Clear all',html:_svgP+'<path d="M3 6h18"/><path d="M8 10v6"/><path d="M12 10v6"/><path d="M16 10v6"/>'+_svgS}), done=h('button',{type:'button','aria-label':'Done',title:'Done',html:'Done'}), cancel=h('button',{type:'button','aria-label':'Cancel',title:'Cancel',html:'Cancel'});

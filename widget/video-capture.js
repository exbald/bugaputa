...
[undo,redo,del,clr].forEach(function(b){ b.style.cssText='min-height:44px;min-width:44px'; });
if(undo.classList.contains('bugaputa-live-labeled')) undo.style.padding='0 10px';
if(redo.classList.contains('bugaputa-live-labeled')) redo.style.padding='0 10px';
if(clr.classList.contains('bugaputa-live-labeled')) clr.style.padding='0 10px';

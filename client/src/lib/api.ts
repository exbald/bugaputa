...
export const api={
  ...
  updateProject:(id:string, data:{ widget_label?: string; widget_color?: string; widget_position?: string; videoCaptureEnabled?: boolean })=>doFetch("/api/projects/"+id,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(data)}),

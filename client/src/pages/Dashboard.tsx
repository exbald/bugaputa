              ...
              return (
                <div key={p.id} className="bg-white border rounded-2xl p-5 flex flex-col gap-3">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <button
                      onClick={() => del(p.id)}
                      className="flex-shrink-0 text-xs px-2 py-1 rounded-lg border hover:bg-red-50 hover:text-red-600 hover:border-red-200"
                    >
                      Delete
                    </button>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    <code className="flex-1 bg-slate-900 text-lime-300 text-xs rounded-lg px-3 py-2 truncate">
                      {key}
                    </code>
                    <button
                      onClick={() => navigator.clipboard.writeText(key)}
                      className="px-3 py-2 rounded-lg border text-xs font-medium hover:bg-slate-50 min-h-[36px]"
                    >
                      Copy
                    </button>
                  </div>
